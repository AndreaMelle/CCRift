...
#define kPrSDKPlayModuleRenderSuiteVersion			5
#define kPrSDKPlayModuleRenderSuiteVersion_4		4
...
typedef struct 
{
	...
	*/
	...
	/**
	**	Force a refresh of the RT segment status for a given timeline
	*/
	prSuiteError (*RefreshRTStatusForAcceleratedRenderer)(
