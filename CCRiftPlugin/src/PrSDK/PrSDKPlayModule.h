...
#include "PrSDKScopeRenderSuite.h"
#endif
...
Message:		playmod_SetVideoDisplayType
Purpose:		Send the current display mode (composite, direct manipulation, scope...) to the player.
Params:			PrVideoDisplayParameters* 
Return values: 
				playmod_ErrNone: success
