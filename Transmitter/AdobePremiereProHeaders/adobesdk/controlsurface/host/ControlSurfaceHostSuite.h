...
#define kADOBESDK_ControlSurfaceHostSuite_VersionCurrent	kADOBESDK_ControlSurfaceHostSuite_Version1
#define	kADOBESDK_ControlSurfaceHostSuiteCurrent			ADOBESDK_ControlSurfaceHostSuite1
...
} ADOBESDK_ControlSurfaceHostSuite1;
