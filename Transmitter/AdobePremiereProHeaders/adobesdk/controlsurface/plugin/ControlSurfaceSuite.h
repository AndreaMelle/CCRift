...
#define kADOBESDK_ControlSurfaceSuite_VersionCurrent	kADOBESDK_ControlSurfaceSuite_Version1
#define	kADOBESDK_ControlSurfaceSuiteCurrent			ADOBESDK_ControlSurfaceSuite1
